...
class SaveSkillItemBlah extends StatefulWidget {
  final bool editMode;
  final String skillId;
  
  SaveSkillItemBlah({Key key, @required this.editMode, this.skillId}) 
    : super(key: key);

  @override
  _SaveSkillItemBlahState createState() => _SaveSkillItemBlahState();
}

class _SaveSkillItemBlahState extends State<SaveSkillItemBlah> {
